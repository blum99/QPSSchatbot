...
export function ChatApp() {
  ...
  const handleSend = async () => {
    ...
    console.log("Sending message with model:", dataSource);
                ...
                {!modelLocked ? (
                  <div className="mx-auto mb-3 flex w-[80%] items-center gap-3">
                    ...
                    <div className="flex gap-1 rounded-lg bg-gray-100 p-1 dark:bg-gray-800">
                      ...
                      <button
                        disabled
                        className="cursor-not-allowed rounded-md px-3 py-1.5 text-sm text-gray-400 opacity-50 dark:text-gray-600"
                      >
                        ILO/SSI
                      </button>
                      <button
